...
class NumPyMpccBicyclePlannerConfiguration:
    horizon: int
...
@dataclass(kw_only=True, frozen=True)
class NumPyMpccUnicyclePlannerConfiguration:
    horizon: int
...
class configure:
    ...
    def planner_from_base(
        *,
        ...
        return NumPyMpccBicyclePlannerConfiguration(
            horizon=horizon,
    ...
    def planner_from_mpcc_unicycle(
        *,
        ...
        return NumPyMpccUnicyclePlannerConfiguration(
            horizon=horizon,
            temperature=temperature,
            reference=reference,
            planner=planner,
