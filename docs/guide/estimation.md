...
If you want to test these settings against synthetic sensor corruption, wrap the obstacle observer using `obstacles.observer.noisy` as shown in the [Obstacle Handling guide](obstacles.md#noisy-observations).
