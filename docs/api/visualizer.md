...
The `faran-visualizer` package generates interactive HTML visualizations for simulation results. For setup and usage, see the [Visualizer guide](../guide/visualizer.md).
